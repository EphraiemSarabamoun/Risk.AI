...
This module defines the continents, territories and adjacency graph for the classic
Risk board game. It also provides a simple command line interface to display the
board information.
"""
